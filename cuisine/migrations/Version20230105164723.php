 ...
 */
final class Version20230105164723 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ingredient_recette (id INT AUTO_INCREMENT NOT NULL, ingredient_id INT DEFAULT NULL, recette_id INT NOT NULL, quantite INT NOT NULL, unite INT DEFAULT NULL, INDEX IDX_488C6856933FE08C (ingredient_id), INDEX IDX_488C685689312FE9 (recette_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
